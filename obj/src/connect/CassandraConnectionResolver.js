 ...
 */
class CassandraConnectionResolver extends pip_services3_components_nodex_1.CompositeConnectionResolver {
    /**
    ...
    mergeConnection(options, connection) {
        ...
        if (uri != null && uri != "") {
            originalOptions = pip_services3_components_nodex_2.ConnectionUtils.parseUri(uri, this._defaultProtocol, this._defaultPort);
            originalOptions = pip_services3_components_nodex_2.ConnectionUtils.rename(originalOptions, "path", "datacenter");
        }
        // Rename common parameters
        originalOptions = pip_services3_components_nodex_2.ConnectionUtils.rename(originalOptions, "database", "datacenter");
        let mergedOptions = pip_services3_components_nodex_2.ConnectionUtils.concat(options, originalOptions, "host", "port");
